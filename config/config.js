...
module.exports = {
    ...
    mongoose: {
        ...
        url: envVars.NODE_ENV === "production" ? envVars.MONGODB_ATLAS_URL : envVars.MONGODB_URL,
        options: {
            useCreateIndex: true,
    ...
    , sms: {
        ...
        DLTTemplateId: envVars.SMS_DLTTEMPLATE_ID,
        peID: envVars.SMS_PEID,
        hash: envVars.SMS_HASH
    }
};